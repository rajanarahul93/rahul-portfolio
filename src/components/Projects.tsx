...
const Projects: React.FC = () => {
  const projects = [
    ...
    },
    {
      title: "Localise",
      description:
        "Hyper-local anonymous notice board PWA connecting users within a 1km radius with real-time posts, comments, and geolocation-based engagement.",
      tags: ["React", "TypeScript", "Supabase", "TailwindCSS", "PWA", "Vite"],
      liveUrl: "https://localise-pwa.vercel.app/",
      githubUrl: "https://github.com/rajanarahul93/localise",
      image: "/projects/localise.png",
      featured: true,
    ...
    },
    {
      title: "FormIQ",
      description:
        "Advanced drag-and-drop form builder with 10+ field types, live preview, conditional logic, and export options including React components, HTML, and JSON.",
      tags: [
        "React",
        "TypeScript",
        "TailwindCSS",
